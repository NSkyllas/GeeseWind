...
st.markdown("Winds are driven by pressure systems: air flows from high to low pressure, but Earth’s rotation bends this flow, creating complex wind patterns. In northern Europe, where our study focuses, the weather is unpredictable. This region sits near the polar front, where warm tropical air meets cold Arctic air. Here, low- and high-pressure systems form frequently, creating a constantly shifting “wind map” that birds must navigate. Migrating birds can use these winds to their advantage, riding tailwinds to save energy.")
st.markdown("We tracked barnacle geese from three populations, each traveling up to 3,000 km between their Arctic breeding grounds and wintering areas. Now, we’re investigating whether these geese strategically follow the winds to make their journeys easier.")
